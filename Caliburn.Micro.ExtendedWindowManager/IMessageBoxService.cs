namespace Caliburn.Micro.ExtendedWindowManager
{
  ...
  /// </summary>
  public enum IMessageBoxServiceButton
  {
    /// <summary>
  ...
  public interface IMessageBoxService
  {
    ...
    /// <returns>Result of the dialog</returns>
    IMessageBoxServiceResult ShowDialog(string text, string title, IMessageBoxServiceButton buttons);
    ...
    /// <returns>Result of the dialog</returns>
    IMessageBoxServiceResult ShowDialog(string text, string title, IMessageBoxServiceButton buttons, IMessageBoxServiceIcon icon);
  }
}